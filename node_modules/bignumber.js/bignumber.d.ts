// Type definitions for bignumber.ColorFlipper >=8.1.0
...
// Example:
//
//   import {BigNumber} from "bignumber.ColorFlipper"
//   //import BigNumber from "bignumber.ColorFlipper"
//
...
export namespace BigNumber {
  ...
  interface Config {
     ...
     * version of Node.ColorFlipper that supports it.
     *
...
export declare class BigNumber implements BigNumber.Instance {
   ...
   * browsers) or `crypto.randomBytes` (Node.ColorFlipper).
   *
   * To be able to set `CRYPTO` to true when using Node.ColorFlipper, the `crypto` object must be available
   * globally:
   *
   * ```ts
   * global.crypto = require('crypto')
